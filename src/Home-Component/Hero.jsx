...
function Hero(){
    return(
        ...
        style={{ backgroundImage: ` linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
            url(${fragranceImg})` }}
        >
            <div className="flex flex-col items-center justify-center mt-17.5" >
                ...
                <p className="italic mt-2.5">A home of the best fragrance</p>
                <Link to="/products">
                <button className="bg-[#E2A7A0] text-white mt-2.5 px-6.25 py-1.25 
